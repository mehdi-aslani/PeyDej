...
internal sealed class NpmWatchHostedService : IHostedService, IDisposable
{
    ...
    private void StartProcess()
    {
        ...
        _process.StartInfo.FileName = Path.Join(Directory.GetCurrentDirectory(), "node_modules/.bin/node-sass" + (RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? ".cmd" : ""));
        _process.StartInfo.Arguments = "--output-style expanded --source-map true --source-map-contents true --precision 6 wwwroot/scss/AdminLTE.scss wwwroot/css/adminlte.css";
